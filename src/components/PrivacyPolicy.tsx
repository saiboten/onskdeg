    ...
    <Container textLeft>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Gaveønske.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Gaveønske, accessible from{" "}
            <a
              href="https://gave%C3%B8nske.no"
      ...
      <ul>
        <li>
          ...
          <a
            href="https://gave%C3%B8nske.no/#/profile"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://gaveønske.no/#/profile
          </a>
        </li>
      </ul>
    </Container>
